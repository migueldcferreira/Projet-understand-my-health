																			...
																			<?php while ($row = $res_prop->fetch()) { ?>
																				<tr>
																						...
																						<td> <?php printf ("%s", $row[3]); ?> </td>
																								...
																								<td>
																						<a href="ajouter.php?id=<?php echo $row[0] ?>"> <button class="btn btn-success btn-sm tooltipsAdmin" title="Ajouter la définition"><i class="far fa-check-circle"></i></button>
