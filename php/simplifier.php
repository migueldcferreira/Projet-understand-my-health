  ...
  function chercherMotBDD($mot, &$bdd, &$numModal,&$motDejaSimplifies)
  {
    ...
    {         
      ...
      if(!empty($rowimg = $resimg->fetch()))
      {
			...
			$texteRetour .= '
					  <button type="button" class="btn btn-outline-primary" data-toggle="tooltip" title=" <img class=\'img-responsive\' style=\'max-height: 800px; max-width: 650px;\' src=\'genererImage.php?id='.$idImage.'\' > <br/>'.$row['DEFINITION'].'">
						'.$mot.'
					  </button>';
